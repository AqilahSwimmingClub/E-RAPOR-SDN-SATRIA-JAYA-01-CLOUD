...
const PRESERVED_COLLECTIONS=['students','attendance','manualAttendance','learningObjectives','cpButir','cpButirScores','assessmentScores','reportScores','subjectMappings','userAccounts','intracurricularActivities','intracurricularScores','dapodikSyncState','dapodikSyncLogs','dapodikMappings','publishedReports'];
