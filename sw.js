...
const APP_SHELL=[
  ...
  './src/styles/app.css','./src/app.js','./src/core/router.js','./src/data/constants.js','./src/data/navigation.js','./src/data/version.js','./src/data/activity-description.js','./src/data/app-identity.js','./src/data/cocurricular.js','./src/data/extracurricular-defaults.js','./src/data/intracurricular-defaults.js',
  ...
  './src/pages/dashboard.js','./src/pages/login.js','./src/pages/objectives.js','./src/pages/placeholder.js','./src/pages/references.js','./src/pages/school-setup.js',
...
const SWAPPABLE_ASSETS=['/assets/login-background.jpg','/assets/logo-sekolah.png','/assets/logo-tut-wuri-handayani.png','/assets/logo-kabupaten-bekasi.png'];
