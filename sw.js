...
const APP_CACHE_VERSION='1.3.16-38';
...
const APP_SHELL=[
  ...
  './src/pages/dashboard.js','./src/pages/login.js','./src/pages/objectives.js','./src/pages/placeholder.js','./src/pages/license-activation.js','./src/pages/references.js','./src/pages/school-setup.js','./src/pages/student-handover.js','./src/pages/about-updates.js','./src/pages/lan-server.js',
  ...
  './src/services/report-import.js','./src/services/snapshots.js','./src/services/migrations.js','./src/services/seed.js','./src/services/storage.js','./src/services/db-backend.js','./src/services/lan-client.js','./src/services/lan-admin.js','./src/services/qr.js','./src/services/students.js',
...
const SWAPPABLE_ASSETS=['/assets/login-background.webp','/assets/app-background.webp','/assets/logo-tut-wuri-handayani.png','/assets/logo-kabupaten-bekasi.png'];
