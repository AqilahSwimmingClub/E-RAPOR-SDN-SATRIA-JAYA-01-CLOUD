...
const APP_SHELL=[
  ...
  './src/pages/dashboard.js','./src/pages/login.js','./src/pages/objectives.js','./src/pages/placeholder.js','./src/pages/license-activation.js','./src/pages/references.js','./src/pages/school-setup.js','./src/pages/student-handover.js',
