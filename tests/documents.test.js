...
function addStudent(index){return createStudent(teacher,{id:`document-${index}`,classId:'5B',nis:`DOC-${index}`,nisn:`440000000${index}`,name:`Siswa Dokumen ${index}`,gender:index%2?'L':'P',religion:'Islam',birthPlace:'Bekasi',birthDate:'2015-02-03',fatherName:'Bapak Dokumen',motherName:'Ibu Dokumen',phone:'0812',address:'Satria Jaya',photo:''});}
